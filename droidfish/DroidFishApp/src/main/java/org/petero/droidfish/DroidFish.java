...
public class DroidFish extends AppCompatActivity
    ...
    private void startTourGuide() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.welcome_dismiss, (dialog, which) -> {
                ...
                .setOnCancelListener(dialog -> {
                    guideShowOnStart = false;
                    settings.edit().putBoolean("guideShowOnStart", false).apply();
                })
                .setCancelable(true)
                .show();
    }
    ...
    private void readPrefs(boolean restartIfLangChange) {
        ...
        bookOptions.filename = settings.getString("bookFile", "internal:");
