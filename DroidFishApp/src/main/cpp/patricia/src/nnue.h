...
INCBIN(nnue, "src/main/cpp/patricia/src/nets/fingolfin.nnue");
INCBIN(nnue2, "src/main/cpp/patricia/src/nets/finarfin.nnue");
INCBIN(nnue3, "src/main/cpp/patricia/src/nets/feanor.nnue");
