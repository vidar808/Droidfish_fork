...
#if defined(__ANDROID__)
    // On Android, CWD is set by Java to the engine data directory.
    // Save it on first call and always reset before relative navigation,
    // mirroring the desktop behavior where each ChDir starts from exe location.
