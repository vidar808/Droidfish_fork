...
## Phase 4: Chess Variants & Game Modes

### 4.0 Chess960 (Fischer Random Chess)

**Priority**: P2 | **Effort**: High | **Impact**: High | **Status**: Planning

**Summary**: Full Chess960 support — position generator, generalized castling logic, Shredder-FEN/X-FEN parsing, UCI_Chess960 engine communication, and New Game UI with variant selection. Both bundled engines (Stockfish 18, Rodent IV 0.33) already support Chess960 natively.

See [`docs/chess960-enhancement.md`](chess960-enhancement.md) for the full implementation plan covering:
- Phase 1: Position model, FEN handling, move generation (core)
- Phase 2: Position generator (960 positions by index)
- Phase 3: UCI engine communication (UCI_Chess960 option)
- Phase 4: UI integration (New Game dialog, Edit Board)
- Phase 5: Testing (unit + integration)

**Key files to modify**: `Position.java`, `TextIO.java`, `MoveGen.java`, `DroidFish.java`, `UCIEngine.java`
**New file**: `Chess960.java` (position generator)

---

## Phase 5: DroidFish Integration
...
## Phase 6: Cloud Engine Integration
...
| Chess960 support (4.0) | High | High | P2 | Planning — [details](chess960-enhancement.md) |
| Chessify integration (6.1) | High | High | P2 | Planned |
| Multi-client (3.3) | Medium | High | P3 | Open |
| Tournament mode (3.4) | Low | High | P4 | Open |
| Server discovery (5.1) | Medium | Medium | P3 | **Done** |
| Enhanced network UI (5.2) | Medium | Medium | P3 | Partially done |
| Bandwidth optimization (5.3) | Low | Medium | P4 | Partially done (OutputThrottler) |
